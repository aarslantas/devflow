...
const QuestionForm = () => {
  ...
  const form = useForm<
    z.infer<typeof AskQuestionSchema>
  >({
    ...
    if (e.key === "Enter") {
      ...
      if (
        ...
        form.setError("tags", {
          type: "maxLength",
          message:
            "Tag should be less than 15 characters",
        });
          ...
          render={({ field }) => (
            <FormItem className="flex w-full flex-col ">
              ...
              <FormDescription className="body-regular mt-2.5 text-light-500">
                ...
                on what you have put in the title.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex w-full flex-col gap-3">
              ...
              <FormDescription className="body-regular mt-2.5 text-light-500">
                Add up to 3 tags to describe ehat
                your question is about. You need
